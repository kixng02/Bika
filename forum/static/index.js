document.addEventListener('DOMContentLoaded', function() {
    ...
    button.addEventListener('click', function() {
        const postId = button.dataset.postId; // You need to set the data-post-id attribute in your HTML
        deletePost(postId);
    });
});
    ...
    function follows(owners_id){
        ...
        var url = '/forum/followers_count/'+owners_id.slice(1);
        console.log(url);
        fetch(url, {
            method: 'POST',
            body: JSON.stringify({
